{-|
Module      : Test.Clash.Crypto.PQC.SLH_DSA.Streaming.Definitions.SLH
Copyright   : Copyright © 2025 QBayLogic B.V.
Maintainer  : QBayLogic B.V.
Stability   : experimental
Portability : POSIX

Test suite for 'Clash.Crypto.PQC.SLH_DSA.Streaming.Definitions.SLH'
Tests regards to algorithms section 9 from NIST FIPS 205
-}
...
module Test.Clash.Crypto.PQC.SLH_DSA.Streaming.Definitions.SLH (tastyTests) where
...
tastyTests =
  testGroup
    "Clash.Crypto.PQC.SLH_DSA.Streaming.Definitions.SLH"
    [ 
...
forsRefImplPython name version input1 =
      ...
      in do
          outputHex <- readProcess
              "python3"
              [ "tests/sim/Test/Clash/Crypto/PQC/SLH_DSA/Streaming/Definitions/slh_worker.py"
              , name
              , version
              , bsToHex input1
              ]
